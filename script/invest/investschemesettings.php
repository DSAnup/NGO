...
$EM = new EntityManagement($Table[$Entity = "InvestSchemeSettings"]);
...
$EM->ImportField([
	...
	new Database\Field("{$Entity}" . ($Field = "ReturnAmount") . "", "{$Field}"),
...
$EM->InputValidation([
	...
	new HTTP\InputValidation("{$Entity}ReturnAmount", true, VALIDATION_TYPE_INTEGER),
...
$EM->ListColumn([
	...
	new HTML\UI\Datagrid\Column("{$Entity}" . ($Caption = "ReturnAmount") . "", "{$Caption}", null),
...
if(isset($_POST["btnInput"])){
	...
	$EM->InputUIHTML([
		...
		HTML\UI\Field(HTML\UI\Input("{$Entity}" . ($Caption = "ReturnAmount") . "", $EM->InputWidth(), null, true), "{$Caption}", null, null, $EM->FieldCaptionWidth()),
