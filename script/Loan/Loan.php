...
if(isset($_POST["btnInput"])){
	...
	$EM->InputUIHTML([
            ...
            HTML\UI\Field(HTML\UI\Select("" . ($Caption = "LoanScheme") . "ID", $Table[$OptionEntity = "{$Caption}"]->Get("{$Table["{$OptionEntity}"]->Alias()}.{$OptionEntity}IsActive = 1", "{$OptionEntity}LookupCaption ASC"), null, "{$OptionEntity}LookupCaption", null, null, null), "{$Caption}", true, null, $EM->FieldCaptionWidth()),
