...
$CreateCustomDataGrid = new HTML\UI\Datagrid(
	...
	"{$Entity}ID",
	[
		new HTML\UI\Datagrid\Action("{$Environment->IconURL()}view.png", null, $Application->URL("Client/LoanView", "btnSubmit"), null, null, null, "View", null, null),
	],
	null,
	null,
	"
